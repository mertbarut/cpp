...
Form::Form( void ) : _name("NULL"), _target("NULL"), _signed(false), _required_grade_sign(150), _required_grade_exec(150)
{
...
Form::Form(	std::string target, std::string name, int required_grade_sign, int required_grade_exec ) : _name(name), _target(target), _signed(false), _required_grade_sign(required_grade_sign), _required_grade_exec(required_grade_exec)
{
	try
	{
